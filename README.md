...
```javascript
vconcat = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vconcat@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var vconcat = require( 'path/to/vendor/umd/ndarray-vconcat/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vconcat@umd/browser.js"></script>
```
